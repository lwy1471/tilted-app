...
window.translations.zh = {
    "meta.title": "在线水平仪 (无需安装应用)",
    "meta.description": "用智能手机即时测量角度 - 无需安装应用！",
    "title": "📱 在线水平仪",
    "welcome": "无需安装应用 - 用智能手机即时测量角度！",
    "mobile_only.title": "无法在电脑上使用",
    "mobile_only.description": "此工具需使用智能手机的传感器，请用移动设备访问 - 无需安装应用！",
    "guide.title": "按按钮开始测量",
    "buttons.start": "📐 开始测量",
